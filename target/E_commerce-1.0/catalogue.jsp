<%-- 
    Document   : catalogue
    Created on : 24 déc. 2021, 01:38:43
    Author     : ADMIN
--%>
...
<%@page import="com.miage.beans.client"%>
...
<html lang="en">
	<head>
		...
		<title>Catalogue - E-commerce la boutique en ligne</title>
			...
			<div class="container">
				...
				<div class="row">
					...
					<div class="col-md-4 col-xs-6">
						<div class="shop">
							<div class="shop-img">
								<img src="bootstrap/img/shop01.png" alt="">
							</div>
							<div class="shop-body">
					...
					<div class="col-md-4 col-xs-6">
						<div class="shop">
							<div class="shop-img">
								<img src="bootstrap/img/shop03.png" alt="">
							</div>
							<div class="shop-body">
					...
					<div class="col-md-4 col-xs-6">
						<div class="shop">
							<div class="shop-img">
								<img src="bootstrap/img/shop02.png" alt="">
							</div>
							<div class="shop-body">
							...
							<div class="products-tabs">
								...
								<div id="tab1" class="tab-pane active">
									<div class="products-slick" data-nav="#slick-nav-1">
										...
										<div class="product">
											<div class="product-img">
												<img src="bootstrap/img/product01.png" alt="">
										...
										<div class="product">
											<div class="product-img">
												<img src="bootstrap/img/product02.png" alt="">
												<div class="product-label">
													<span class="new">NEW</span>
												</div>
											</div>
										...
										<div class="product">
											<div class="product-img">
												<img src="bootstrap/img/product03.png" alt="">
												<div class="product-label">
													<span class="sale">-30%</span>
												</div>
											</div>
										...
										<div class="product">
											<div class="product-img">
												<img src="bootstrap/img/product04.png" alt="">
											</div>
											<div class="product-body">
												<p class="product-category">Category</p>
												<h3 class="product-name"><a href="#">product name goes here</a></h3>
										...
										<div class="product">
											<div class="product-img">
												<img src="bootstrap/img/product05.png" alt="">
											</div>
											<div class="product-body">
												<p class="product-category">Category</p>
												<h3 class="product-name"><a href="#">product name goes here</a></h3>
		...
		<div class="section">
			...
			<div class="container">
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="section-title">
							<h3 class="title">Plus Vendus</h3>
							<div class="section-nav">
								<ul class="section-tab-nav tab-nav">
									<li class="active"><a data-toggle="tab" href="#tab2">Ordinateurs</a></li>
							...
							<div class="products-tabs">
								...
								<div id="tab2" class="tab-pane fade in active">
									<div class="products-slick" data-nav="#slick-nav-2">
										...
										<div class="product">
											<div class="product-img">
												<img src="bootstrap/img/product06.png" alt="">
												<div class="product-label">
													<span class="sale">-30%</span>
													<span class="new">NEW</span>
												</div>
										...
										<div class="product">
											<div class="product-img">
												<img src="bootstrap/img/product07.png" alt="">
												<div class="product-label">
													<span class="new">NEW</span>
												</div>
											</div>
										...
										<div class="product">
											<div class="product-img">
												<img src="bootstrap/img/product08.png" alt="">
												<div class="product-label">
													<span class="sale">-30%</span>
												</div>
											</div>
										...
										<div class="product">
											<div class="product-img">
												<img src="bootstrap/img/product09.png" alt="">
											</div>
											<div class="product-body">
												<p class="product-category">Category</p>
												<h3 class="product-name"><a href="#">product name goes here</a></h3>
