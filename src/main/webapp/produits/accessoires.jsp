<%-- 
    ...
    Created on : 29 déc. 2021, 04:15:47
    Author     : ADMIN
--%>
			...
			<div class="container">
				...
				<div id="responsive-nav">
					...
					<ul class="main-nav nav navbar-nav">
						...
						<li><a href="ordinateurs.jsp">Ordinateurs</a></li>
						<li><a href="smartphones.jsp">Smartphones</a></li>
						<li><a href="cameras.jsp">Cameras</a></li>
						<li class="active"><a href="accessoires.jsp">Accessoires</a></li>
					</ul>
					<!-- /NAV -->
				</div>
				<!-- /responsive-nav -->
						...
						<div class="section-title">
							...
							<div class="section-nav">
								<ul class="section-tab-nav tab-nav">
									<li><a data-toggle="tab">Ordinateurs</a></li>
						...
						<div class="row">
							...
							<div class="products-tabs">
                                                            ...
                                                            <div id="tab1" class="tab-pane active">
                                                                <%
                                                                   if (rs.getString("categorie").equals("Accessoires")){
                                                                %>
